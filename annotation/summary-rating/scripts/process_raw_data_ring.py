...
def process_pair_data(df, min_comparisons_per_summary=3):
    ...
    for (question, num_samples_group), group in question_sample_groups:
        ...
        pairs_created, summary_counts = create_ring_pairs(summaries)
...
def main():
    ...
    if not args.skip_rating:
        ...
        rating_output_path = os.path.join(args.output_dir, 'sum_humanstudy_rating_full_ring.csv')
    ...
    if not args.skip_pair:
        ...
        pair_output_path = os.path.join(args.output_dir, 'sum_humanstudy_pair_full_ring.csv')
    ...
    if not args.skip_triplet:
        ...
        triplet_output_path = os.path.join(args.output_dir, 'sum_humanstudy_triplet_full_ring.csv')
