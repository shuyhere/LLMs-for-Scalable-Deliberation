...
def remove_users_from_data(users):
    ...
    # 设置路径
    task_assignment_path = '/home/ec2-user/LLMs-Scalable-Deliberation/annotation/summary-rating/annotation_output/full_ablation/task_assignment.json'
    annotation_data_dir = '/home/ec2-user/LLMs-Scalable-Deliberation/annotation/summary-rating/annotation_output/full_ablation'
